					...
					<div class="row">
						<div class="small-24 medium-12 columns text-center medium-text-left large-text-left">
								<?php if ( get_field('footer_logo','options' ) ): ?>
									...
									<a title="<?php echo esc_attr( get_bloginfo('name', 'display') ); ?>" class="footer-logo text-left " href="<?php echo esc_url( home_url( '/' ) ); ?>"><img src="<?php echo $footerImage['url']; ?>" alt="<?php echo esc_attr( get_bloginfo('name', 'display') ); ?>" title="<?php echo esc_attr( get_bloginfo('name', 'display') ); ?>" /></a>
								<?php else: ?>
									<h3><? bloginfo('name'); ?></h3>
								<?php endif; ?>
							...
							<ul class="nobullets">
								...
								<li class="phone" >
									<strong>Phone:</strong> <a class="phone" title="Call Us Today!" href="tel:<?php echo textivia_cleanphonenumber(get_field("phone","options")); ?>"><?php the_field("phone","options"); ?></a>
								</li>
								<?php endif; ?>
